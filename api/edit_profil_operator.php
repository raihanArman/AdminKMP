    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if($gambar != null){
            ...
            if($sql_tampil){
                ...
                $query_edit = "UPDATE tb_user SET username = '$username', nama = '$nama', alamat = '$alamat',no_telp = '$noTelp', gambar = '$filename' WHERE id_user = $id_user";
            ...
            $query_edit = "UPDATE tb_user SET username = '$username', nama = '$nama', alamat = '$alamat',no_telp = '$noTelp' WHERE id_user = $id_user";
            $sql_edit = mysqli_query($con, $query_edit);
            if($sql_edit){
                $res['value'] = 1;
                $res['message'] = "Berhasil edit";
